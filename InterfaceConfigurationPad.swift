//
//  InterfaceConfigurationPad.swift
//  CoreKit
//
...
public struct InterfaceConfigurationPad {
    
    public var toolMenuPage = ToolMenuPage.uninitialized
    //public var heightCategory = MenuHeightCategoryPad.standard
    
    public var isExpandedTop = true // *NOT USED*
    public var isExpandedBottom = true // *NOT USED*
