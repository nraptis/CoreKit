...
public class GuideRenderer {
    ...
    public func pre_prepare(renderInfo: JiggleRenderInfo,
        ...
        if renderInfo.isShowingGuidePoints {
            ...
            for guidePointIndex in 0..<guidePointCount {
                ...
                var renderPoint = guidePoint.point
                ...
                case .unselected:
                    if isSelected == true {
                        if selectedGuidePointIndex == guidePointIndex {
                ...
                guidePoint.renderX = renderPoint.x
                guidePoint.renderY = renderPoint.y
                guidePoint.renderPointSelected = isPointSelected
                ...
                guidePoint.renderTanInSelected = isTanInSelected
                guidePoint.renderTanOutSelected = isTanOutSelected
        ...
        if renderInfo.isShowingGuidePointTanHandles {
            for guidePointIndex in 0..<guidePointCount {
                ...
                var tanHandleIn = guidePoint.getTanHandleIn()
                ...
                var tanHandleOut = guidePoint.getTanHandleOut()
                ...
                guidePoint.renderTanInX = tanHandleIn.x
                guidePoint.renderTanInY = tanHandleIn.y
                
                guidePoint.renderTanOutX = tanHandleOut.x
                guidePoint.renderTanOutY = tanHandleOut.y
                
                var tanNormalsIn = guidePoint.getTanHandleNormalsIn()
                ...
                guidePoint.renderTanNormalInX = tanNormalsIn.x
                guidePoint.renderTanNormalInY = tanNormalsIn.y
                
                var tanNormalsOut = guidePoint.getTanHandleNormalsOut()
                ...
                tanNormalsOut = Math.transformVector(vector: tanNormalsOut,
                                                     scale: 1.0,
                                                     rotation: jiggleRotation)
                guidePoint.renderTanNormalOutX = tanNormalsOut.x
                guidePoint.renderTanNormalOutY = tanNormalsOut.y
            }
        }
    }
    ...
    public func prepare(renderInfo: JiggleRenderInfo,
        ...
        preparePoints(renderInfo: renderInfo,
                      ...
                      guidePointCount: guidePointCount,
