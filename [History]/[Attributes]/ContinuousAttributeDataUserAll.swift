...
public struct ContinuousAttributeDataUserAll {
    ...
    public init(duration: Float, angle: Float, power: Float, swoop: Float, frameOffset: Float, startScale: Float, endScale: Float, startRotation: Float, endRotation: Float) {
