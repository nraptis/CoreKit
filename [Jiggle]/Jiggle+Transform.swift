...
public extension Jiggle {
    ...
    func untransformTanHandles(_ tanHandles: TanHandles) -> TanHandles {
        var inPoint = Point(x: tanHandles.inX, y: tanHandles.inY)
        inPoint = untransformPoint(point: inPoint)
        var outPoint = Point(x: tanHandles.outX, y: tanHandles.outY)
        outPoint = untransformPoint(point: outPoint)
        return .init(inX: inPoint.x, inY: inPoint.y,
                     outX: outPoint.x, outY: outPoint.y)
    }
}
