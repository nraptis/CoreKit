...
//
public class AnimationInstructionGrab: AnimationCommandsCommandable {
    ...
    static let speedLoMin = Float(420.0)
    static let speedLoMax = Float(820.0)
    ...
    static let grabDragGyroPowerMultiplierLo = Float(0.15)
    static let grabDragGyroPowerMultiplierRange = Float(0.85)
    
    static let stiffnessMultiplierCap = Float(0.48)
    static let stiffnessMultiplierMinus = Float(0.44)
    
    static let GLOBAL_FLING_PHONE = Float(1.15)
    static let GLOBAL_FLING_PAD = Float(1.075)
    
    static let flingLargePhone_000 = Float(0.43721876) * GLOBAL_FLING_PHONE
    static let flingLargePhone_025 = Float(0.74833775) * GLOBAL_FLING_PHONE
    static let flingLargePhone_050 = Float(0.8921888) * GLOBAL_FLING_PHONE
    static let flingLargePhone_075 = Float(0.97450274) * GLOBAL_FLING_PHONE
    static let flingLargePhone_100 = Float(1.0308849) * GLOBAL_FLING_PHONE
    
    static let flingMediumPhone_000 = Float(0.44604832) * GLOBAL_FLING_PHONE
    static let flingMediumPhone_025 = Float(0.7766216) * GLOBAL_FLING_PHONE
    static let flingMediumPhone_050 = Float(0.9285125) * GLOBAL_FLING_PHONE
    static let flingMediumPhone_075 = Float(1.015327) * GLOBAL_FLING_PHONE
    static let flingMediumPhone_100 = Float(1.0747646) * GLOBAL_FLING_PHONE
    
    static let flingSmallPhone_000 = Float(0.4608757) * GLOBAL_FLING_PHONE
    static let flingSmallPhone_025 = Float(0.82453537) * GLOBAL_FLING_PHONE
    static let flingSmallPhone_050 = Float(0.9900773) * GLOBAL_FLING_PHONE
    static let flingSmallPhone_075 = Float(1.0845323) * GLOBAL_FLING_PHONE
    static let flingSmallPhone_100 = Float(1.1491463) * GLOBAL_FLING_PHONE
    
    static let flingLargePad_000 = Float(0.47225678) * GLOBAL_FLING_PAD
    static let flingLargePad_025 = Float(0.8203307) * GLOBAL_FLING_PAD
    static let flingLargePad_050 = Float(0.9812279) * GLOBAL_FLING_PAD
    static let flingLargePad_075 = Float(1.0733016) * GLOBAL_FLING_PAD
    static let flingLargePad_100 = Float(1.1363759) * GLOBAL_FLING_PAD
    
    static let flingMediumPad_000 = Float(0.49242094) * GLOBAL_FLING_PAD
    static let flingMediumPad_025 = Float(0.86781204) * GLOBAL_FLING_PAD
    static let flingMediumPad_050 = Float(1.0402796) * GLOBAL_FLING_PAD
    static let flingMediumPad_075 = Float(1.1388471) * GLOBAL_FLING_PAD
    static let flingMediumPad_100 = Float(1.2063453) * GLOBAL_FLING_PAD
    
    static let flingSmallPad_000 = Float(0.529457) * GLOBAL_FLING_PAD
    static let flingSmallPad_025 = Float(0.9540771) * GLOBAL_FLING_PAD
    static let flingSmallPad_050 = Float(1.1473556) * GLOBAL_FLING_PAD
    static let flingSmallPad_075 = Float(1.2576535) * GLOBAL_FLING_PAD
    static let flingSmallPad_100 = Float(1.3330941) * GLOBAL_FLING_PAD
    ...
    func update_Active(deltaTime: Float,
        ...
        let measuredSize = animationWad.measuredSize
        let measurePercentLinear = AnimationWad.getMeasurePercentLinear(measuredSize: measuredSize)
        let distanceR2 = AnimationWad.getAnimationCursorFalloffDistance_R2(measurePercentLinear: measurePercentLinear)
        
        if !animationWad.isCaptureActiveGrab {
            
            let grabDragSpeedPercentLinear = AnimationWad.getGrabDragSpeedPercentLinear(userGrabDragSpeed: animationWad.grabSpeed)
            let grabDragStiffnessPercentLinear = AnimationWad.getGrabDragStiffnessPercentLinear(userGrabDragStiffness: animationWad.grabStiffness)
            
            var cursorX = animationWad.animationCursorX
            var cursorY = animationWad.animationCursorY
            
            var cursorXScale = cursorScaleSamplerX
            var cursorXRotation = cursorRotationSamplerX
            
            let gyroX = gyroSmoothX
            let gyroY = gyroSmoothY
            ...
            let grabDragGyroPowerPercentLinear = AnimationWad.getGrabDragGyroPowerPercentLinear(userGrabDragGyroPower: animationWad.grabGyroPower)
            ...
            animationWad.animationCursorX = cursorX
            animationWad.animationCursorY = cursorY
            ...
            if cursorScaleSamplerX != 0.0 {
                if cursorScaleSamplerX > 0.0 {
                    ...
                    let climb = AnimationWad.animationCursorFalloffScale_U2 - 1.0
                    animationWad.animationCursorScale = 1.0 + percent * climb
                } else {
                    let percent = -(cursorScaleSamplerX / distanceR2)
                    let climb = 1.0 - AnimationWad.animationCursorFalloffScale_D2
                    animationWad.animationCursorScale = 1.0 - percent * climb
                }
            } else {
            ...
            if cursorRotationSamplerX != 0.0 {
                if cursorRotationSamplerX > 0.0 {
                    ...
                    let climb = AnimationWad.animationCursorFalloffRotation_U2
                    animationWad.animationCursorRotation = percent * climb
                } else {
                    let percent = cursorRotationSamplerX / distanceR2
                    let climb = AnimationWad.animationCursorFalloffRotation_D2
                    animationWad.animationCursorRotation = -percent * climb
                }
            } else {
        ...
        let diffX = animationWad.animationCursorX
        let diffY = animationWad.animationCursorY
    ...
    func fling(measuredSize: Float,
        ...
        if totalTime > Math.epsilon {
            ...
            fling(measuredSize: measuredSize,
                  grabSpeed: grabSpeed,
                  powerX: powerX,
                  powerY: powerY)
        }
    ...
    func fling(measuredSize: Float,
        ...
        let grabDragSpeedPercentLinear = AnimationWad.getGrabDragSpeedPercentLinear(userGrabDragSpeed: grabSpeed)
    ...
    func getGyroMultiplier(grabDragSpeedPercent: Float,
        ...
        let gyroMultiplier = Math.interpolate3(inputMin: AnimationWad.minMeasuredSize,
                                               inputMid: AnimationWad.midMeasuredSize,
                                               inputMax: AnimationWad.maxMeasuredSize,
                                               input: measuredSize,
    ...
    func getFlingMultiplier(grabDragSpeedPercent: Float,
        ...
        let flingMultiplier = Math.interpolate3(inputMin: AnimationWad.minMeasuredSize,
                                                inputMid: AnimationWad.midMeasuredSize,
                                                inputMax: AnimationWad.maxMeasuredSize,
                                                input: measuredSize,
    ...
    func registerCursorScale(animationWad: AnimationWad, scale: Float) {
        let measuredSize = animationWad.measuredSize
        let measurePercentLinear = AnimationWad.getMeasurePercentLinear(measuredSize: measuredSize)
        let distanceR2 = AnimationWad.getAnimationCursorFalloffDistance_R2(measurePercentLinear: measurePercentLinear)
        if scale >= 1.0 {
            let scalePercent = (scale - 1.0) / (AnimationWad.animationCursorFalloffScale_U2 - 1.0)
            cursorScaleSamplerX = scalePercent * distanceR2
        } else {
            let scalePercent = (1.0 - scale) / (1.0 - AnimationWad.animationCursorFalloffScale_D2)
            cursorScaleSamplerX = -(scalePercent * distanceR2)
        }
    }
    
    func registerCursorRotation(animationWad: AnimationWad, rotation: Float) {
        let measuredSize = animationWad.measuredSize
        let measurePercentLinear = AnimationWad.getMeasurePercentLinear(measuredSize: measuredSize)
        let distanceR2 = AnimationWad.getAnimationCursorFalloffDistance_R2(measurePercentLinear: measurePercentLinear)
        ...
        if fixedRotation >= 0.0 {
            let rotationPercent = (fixedRotation) / AnimationWad.animationCursorFalloffRotation_U2
            cursorRotationSamplerX = rotationPercent * distanceR2
        } else {
            let rotationPercent = (fixedRotation) / AnimationWad.animationCursorFalloffRotation_D2
            cursorRotationSamplerX = -(rotationPercent * distanceR2)
        }
    }
